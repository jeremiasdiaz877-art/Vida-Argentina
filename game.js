...
function procesarTurno(dado) {
  ...
  j._resumen = {
    saldoAntes, ingresoSueldo, retornoEmpresa, retornoAcciones, alquiler,
    gastosFijos, cuotaTotal, costoCarrera, evento, impactoEvento, impuesto,
    saldoDespues: j.saldo
  };
...
function mostrarResumenTurno(j) {
  ...
  html += `<div style="background:var(--gris);border-radius:12px;padding:14px;margin-bottom:16px;">
    ...
    <table style="width:100%;font-size:14px;">
      ...
      ${linea("📈 Acciones", r.retornoAcciones, false)}
      ${linea("🏠 Alquileres", r.alquiler, false)}
      ${linea("🏠 Gastos fijos", r.gastosFijos, true)}
      ${linea("🏦 Cuotas de préstamos", r.cuotaTotal, true)}
